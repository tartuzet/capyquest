...
export class BossScene extends Phaser.Scene {
  ...
  private launchLog(): void {
    ...
    const projectile = this.projectiles.create(this.boss.x - 75, this.boss.y - 10, 'moving-platform') as Phaser.Physics.Arcade.Image;
    this.audio.playShoot(this);
    projectile.setDisplaySize(46, 18);
    projectile.setVelocityX(-220 - (3 - this.boss.hp) * 60);
